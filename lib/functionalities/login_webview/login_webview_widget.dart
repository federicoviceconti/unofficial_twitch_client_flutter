...
class _LoginWebViewWidgetState extends BaseState<LoginWebViewWidget>
  ...
  Widget _buildBody() {
    return Consumer<LoginWebViewViewModel>(builder: _buildWebView);
  }

  Widget _buildWebView(
    BuildContext context,
    LoginWebViewViewModel notifier,
    Widget? child,
  ) {
